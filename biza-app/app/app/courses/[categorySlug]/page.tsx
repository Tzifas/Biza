      ...
      <main className="flex-grow bg-cream py-12">
        <div className="mx-auto max-w-7xl space-y-8 px-4 sm:px-6 lg:px-8">
          <div className="space-y-3">
            <Link href="/app/courses" className="text-xs font-medium text-leaf hover:text-forest">
              ← All categories
            </Link>
            ...
            {category.opportunities.map((ref) => {
              ...
              return (
                <Card key={ref.slug} className="flex flex-col justify-between">
                  ...
                  <div className="pt-6">
                    {live ? (
                      <Button href={`/app/courses/${categorySlug}/${ref.slug}`} variant="secondary" className="w-full text-xs">
                        View opportunity
                        <ArrowRight size={14} />
                      </Button>
                    ) : (
