        ...
        <section className="bg-forest py-12 text-white">
          <div className="mx-auto max-w-7xl space-y-4 px-4 sm:px-6 lg:px-8">
            <nav className="flex flex-wrap items-center gap-1.5 text-xs text-cream/70">
              <Link href="/app/courses" className="hover:text-gold">
                Courses
              </Link>
              <span>/</span>
              <Link href={`/app/courses/${categorySlug}`} className="hover:text-gold">
                {category.name}
              </Link>
              <span>/</span>
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-8 px-4 py-10 sm:px-6 lg:grid-cols-12 lg:px-8">
          ...
          <div className="space-y-4 lg:col-span-4">
            <Card hover={false} className="space-y-4">
              ...
              <Button href={`/app/courses/${categorySlug}/${opportunitySlug}/learn`} variant="primary" className="w-full">
                Start course
                <ArrowRight size={14} />
              </Button>
